...
from models.proximity import Proximity
from models.contrastive_proximity import Con_Proximity
from models import resnet_96x96,resnet_ova # Imports the ResNet Model
...
parser.add_argument('--schedule', type=int, nargs='+', default=[142, 230, 360],
                    help='Decrease learning rate at these epochs.') #[142, 230, 360]
...
def main():
    ...
    trainset = torchvision.datasets.STL10(root='./', split='train',
    ...
    # Loading the Model
    model = resnet_96x96.resnet(num_classes=num_classes, depth=110)
    ...
    for epoch in range(args.max_epoch):
        ...
        if args.eval_freq > 0 and (epoch + 1) % args.eval_freq == 0 or (epoch + 1) == args.max_epoch:
            ...
            torch.save(state_, './STL-10_PCL_pretrained_final.pth.tar')
